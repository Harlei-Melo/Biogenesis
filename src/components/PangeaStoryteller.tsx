...
const steps = [
    {
        pergunta: "A terra firme é árida. O que é necessário para a vida vegetal prosperar?",
    ...
    {
        pergunta: "A flora dominou a terra. Que gigantes logo reinarão sobre este mundo?",
        palavrasChave: ['dinossauro', 'dinossauros', 'dino', 'repteis', 'répteis', 't-rex', 'trex'],
            ...
            <div style={glassStyle}>
                {sucesso ? (
                    <div style={{ animation: 'fadeIn 0.5s ease-in' }}>
                        <h2 style={{ fontSize: '1.4rem', fontWeight: 500, color: '#00ff88', margin: 0 }}>
                            {step.msgSucesso}
                        </h2>
                    </div>
                ) : (
                    <>
                        <h2 style={{ fontSize: '1.3rem', fontWeight: 300, marginBottom: '25px', lineHeight: 1.5 }}>
                            {step.pergunta}
                        </h2>

                        <form onSubmit={handleSubmit} style={{ display: 'flex', gap: '12px', height: '45px' }}>
                            <input
                                type="text"
                                value={inputVal}
                                ...
                                style={{
                                    ...
                                    border: erro ? '1px solid #ff4444' : '1px solid rgba(255, 255, 255, 0.3)',
                                    borderRadius: '10px',
                                    padding: '0 18px',
                                    color: 'white',
                                    outline: 'none',
                            ...
                            <button
                                ...
                                onMouseOver={(e) => e.currentTarget.style.background = '#dddddd'}
